...
interface AgentsErrorBoundaryState {
  hasError: boolean;
  error?: Error;
}
...
export class AgentsErrorBoundary extends React.Component<
  AgentsErrorBoundaryProps,
  AgentsErrorBoundaryState
> {
  constructor(props: AgentsErrorBoundaryProps) {
    super(props);
    this.state = { hasError: false };
  }

  static getDerivedStateFromError(error: Error): AgentsErrorBoundaryState {
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  Não foi possível carregar seus agentes IA. Verifique sua
