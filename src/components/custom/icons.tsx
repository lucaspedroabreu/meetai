...
export function ErrorIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={cn("text-red-600 flex-shrink-0", className)}
      width={size}
      height={size}
      fill="none"
      stroke="currentColor"
...
export function SuccessIcon({ className, size = 32 }: IconProps) {
  return (
    <svg
...
export function LoadingSpinner({ className, size = 16 }: IconProps) {
  return (
    <div
      className={cn(
